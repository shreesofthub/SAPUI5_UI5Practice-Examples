		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Get selected table row values",
									"targetURL": "#upeupetable1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"upeupetable1-display": {
								"semanticObject": "upeupetable1",
								"action": "display",
								"description": "Get Selected Table Row Values",
								"title": "Get selected table row values",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=upe.upetable1",
									"url": sap.ui.require.toUrl("upe/upetable1")
								}
							}
						}
					}
